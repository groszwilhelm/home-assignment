export class IconEmailSecurity extends HTMLElement {
  public static register(): void {
    window.customElements.define('hmw-icon-email-security', IconEmailSecurity);
  }
...
template.innerHTML = IconEmailSecurity.template;
